...
alias set_default_keyboard_layout='setxkbmap -layout de -option ctrl:nocaps && xmodmap -e "keycode 111 = Mode_switch NoSymbol Mode_switch" && xmodmap -e "keycode 8 = Alt_L Meta_L Alt_L Meta_L"'
